  ...
  <body>
	...
	<script>
		function checkAvailability() {
			$("#loaderIcon").show();
			jQuery.ajax({
				url		: "check_availability_kd_dosen.php",
				data	: 'nik='+$("#nik").val(),
				type	: "POST",
        ...
        <div class="container">
            ...
            <div class="row contact-wrap">
                ...
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <form action="admin_data_dosen_kueri_insert.php" method="post" role="form" class="contactForm">
						...
						<div class="form-group">
								<input type="text" class="form-control" name="nama_dosen" id="nama_dosen" placeholder="Nama" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" required />
								<div class="validation"></div>
						</div>
						<div class="form-group">
								<input type="text" class="form-control" name="jabatan" id="jabatan" placeholder="Jabatan" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" />
								<div class="validation"></div>
						</div>
						<div class="form-group">
