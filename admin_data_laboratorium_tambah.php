  ...
  <body>
	...
	<script>
		function checkAvailability() {
			$("#loaderIcon").show();
			jQuery.ajax({
				url		: "check_availability_kd_ruang.php",
        ...
        <div class="container">
            ...
            <div class="row contact-wrap">
                ...
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <form action="admin_data_laboratorium_kueri_insert.php" method="post" role="form" class="contactForm">
						...
						<div class="form-group">
								<input type="text" class="form-control" name="kd_ruang" id="kd_ruang" placeholder="Kode Laboratorium" data-rule="minlen:4" data-msg="Please enter at least 4 chars" onBlur="checkAvailability()" required />
								<span id="user-availability-status"></span>
								<p><img src="images/LoaderIcon.gif" id="loaderIcon" style="display:none" width="100" height="70"/></p>
								<div class="validation"></div>
						</div>
						<div class="form-group">
								<input type="text" class="form-control" name="nama_lab" id="nama_lab" placeholder="Nama Laboratorium" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" required />
								<div class="validation"></div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
								<input type="text" class="form-control" name="nik_dosen_pj" id="nik_dosen_pj" placeholder="NIK Dosen Penanggung Jawab" data-rule="minlen:4" data-msg="Please enter at least 4 chars" style="pointer-events:none; background:#F0F0F0;" required />
								<div class="validation"></div>
						</div>
