	...
	<div id="breadcrumb">
		<div class="container">	
			<div class="breadcrumb">							
				<li><a href="dosen_data_absensi_lihat.php?lihat=<?php echo $kd_mata_kuliah; ?>">Data Absensi</a></li>
	...
	<div class="container" style="color:black;">
		<div class="panel panel-default">
			...
			<div align="center">
				...
				<form action="dosen_data_absensi_praktikum_kueri_insert.php" method="post" role="form" class="contactForm">
