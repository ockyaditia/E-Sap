  ...
  <body>
	...
	<div class="container" style="color:black;">
		<div class="panel panel-default">
			...
			<div align="right">
				<a href ="admin_data_fakultas_tambah.php">
					...
					<table class="table table-striped table-bordered table-hover" id="dataTables-example">
						<thead>
							<tr>
								...
								<th style="cursor:pointer;"><center>Kode Fakultas <img src="data-grid/datatables/media/images/sort_both.png"></center></th>
								<th style="cursor:pointer;"><center>Nama Fakultas <img src="data-grid/datatables/media/images/sort_both.png"></center></th>
								<th>Opsi</th>
							</tr>
						</thead>
						<tbody>
							...
							?>
								<tr>
									...
									<td><center><?php echo $data['kd_fakultas']; ?></center></td>
									<td><center><?php echo $data['nama_fakultas']; ?></center></td>
									<td>
										<center>
											<a href="admin_data_fakultas_ubah.php?ubah=<?php echo $data['kd_fakultas']; ?>">
												<img src="images/edit_green.png" style="margin-left:10px;" width="30" height="30"/>
											</a>
										
											<a href="admin_data_fakultas_kueri_delete.php?hapus=<?php echo $data['kd_fakultas']; ?>" onclick="return doconfirm()">
