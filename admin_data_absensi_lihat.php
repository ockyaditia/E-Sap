	...
	<div class="services">
		<div class="container">
			...
			<div class="col-md-6">
				<center>
					<h4>Teori</h4>
					<a href="admin_data_absensi_teori_lihat.php?lihat=<?php echo $kd_mata_kuliah; ?>"><img src="images/student.png" class="img-responsive" width="100"></a>
				</center>
			</div>
			<?php
				}
			...
			<div class="col-md-6">
				<center>
					<h4>Praktikum</h4>
					<a href="admin_data_absensi_praktikum_lihat.php?lihat=<?php echo $kd_mata_kuliah; ?>"><img src="images/student.png" class="img-responsive" width="100"></a>
				</center>
			</div>
			<?php
				}
