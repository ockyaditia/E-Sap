  ...
  <body>
	...
	<script>
		function checkAvailability() {
			$("#loaderIcon").show();
			jQuery.ajax({
				url		: "check_availability_kd_ruang_kelas_ubah.php",
            ...
            <div class="row contact-wrap">
				...
				?>
					<div class="alert alert-danger" role="alert">
						<center><strong>Gagal Ubah Data!</strong>. Kode Ruang Telah Terdaftar.</center>
					</div>
				<?php
                ...
                <div class="col-md-6 col-md-offset-3">
					...
					<?php
						...
						$sql = "SELECT * FROM ruang WHERE kd_ruang='$kd_ruang'";
                    ...
                    <form action="admin_data_ruang_kueri_update.php" method="post" role="form" class="contactForm">
						...
						<div class="form-group">
								...
								<input type="text" class="form-control" name="kd_ruang" id="kd_ruang" placeholder="Kode Ruang" data-rule="minlen:4" data-msg="Please enter at least 4 chars" onBlur="checkAvailability()" required value="<?php echo $kd_ruang; ?>"/>
								<span id="user-availability-status"></span>
								<p><img src="images/LoaderIcon.gif" id="loaderIcon" style="display:none" width="100" height="70"/></p>
								<div class="validation"></div>
						</div>
						<div class="form-group">
								<input type="text" class="form-control" name="nama_ruang" id="nama_ruang" placeholder="Nama Ruang" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" required value="<?php echo $nama_ruang; ?>"/>
								<div class="validation"></div>
						</div>
				...
				<?php
						...
						header('location:admin_data_ruang_lihat.php');
					}
				?>
            </div><!--/.row-->
        </div><!--/.container-->
