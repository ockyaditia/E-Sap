	...
	<div id="breadcrumb">
		<div class="container">	
			<div class="breadcrumb">							
				...
				<li>Data Tata Usaha Universitas</li>			
			</div>		
		</div>	
	</div>
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td><center>
										<?php
											$sql2 = "SELECT * from user_akses WHERE kd_user = '".$data['nik']."'";
									...
									<td>
										<center>
											<a href="admin_data_tata_usaha_universitas_ubah.php?ubah=<?php echo $data['nik']; ?>">
												<img src="images/edit_green.png" style="margin-left:10px;" width="30" height="30"/>
											</a>
										
											<a href="admin_data_tata_usaha_universitas_kueri_delete.php?hapus=<?php echo $data['nik']; ?>" onclick="return doconfirm()">
