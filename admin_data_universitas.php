					...
					<ul>
						...
						<li>
							...
							<div class="media-body">
								...
								<p>
									<a href="admin_data_fakultas_lihat.php"><button class="btn btn-primary btn-lg">Lihat Daftar Fakultas</button></a>
									<a href="admin_data_fakultas_tambah.php"><button class="btn btn-primary btn-lg">Tambah Daftar Fakultas</button></a>
								</p>
							</div>
						</li>
						<?php
						...
						<li>
							...
							<div class="media-body">
								...
								<p>
									<a href="admin_data_program_studi_lihat.php"><button class="btn btn-primary btn-lg">Lihat Daftar Program Studi</button></a>
									<a href="admin_data_program_studi_tambah.php"><button class="btn btn-primary btn-lg">Tambah Daftar Program Studi</button></a>
								</p>
							</div>
						</li>
					</ul>
