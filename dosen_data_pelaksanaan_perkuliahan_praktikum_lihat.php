	...
	<div class="container" style="color:black;">
		<div class="panel panel-default">
			...
			<div align="center">
				...
				<form action="dosen_data_pelaksanaan_perkuliahan_praktikum_kueri_insert.php" method="post" role="form" class="contactForm">
					...
					<table class="pel_per">
						...
						<tr>
							...
							<th><h5><b>
								<?php
									require ("config/config.php");
									$sql3 = "SELECT * from laboratorium WHERE kd_prodi='".$_SESSION['kd_prodi']."' AND kd_ruang = '$kd_ruang'";
									...
									$data3 = $result3->fetch_assoc();
								?>
								<input type="text" value="<?php echo $data3['nama_lab']; ?>" placeholder="Lab" readonly disabled />
							</b></h5></th>
						</tr>
					</table>
					<br>
