	...
	<div class="container" style="color:black;">
		<div class="panel panel-default">
			...
			<div align="center">
				...
				<form action="admin_data_pelaksanaan_perkuliahan_teori_kueri_insert.php" method="post" role="form" class="contactForm">
						...
						<tr>
							...
							<th><h5><b>
								<select name="lab" id="lab">
									...
									<?php
										require ("config/config.php");
										$sql3 = "SELECT * from ruang WHERE kd_prodi='".$_SESSION['kd_prodi']."'";
									...
									?>
									<option value="<?php echo $data3['nama_ruang'];?>"
									<?php
										if ($nama_ruang == $data3['nama_ruang']) {
											echo ' selected="selected"';
										} 
									?>
										>
									<?php
											echo $data3['nama_ruang'];
									?>
									</option>
									<?php
										}
								...
								<script>
									$('#lab').on('change', function() {
										...
										if (lab != "") {
											$.post('ajax_get_kode_ruang_kelas.php', {nama_ruang:lab},
											function(data) {
												$('#kd_ruang').val(data);
											});
										}
