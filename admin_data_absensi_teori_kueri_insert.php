<?php
	...
	if (!$result = $mysqli->query($sql)) {
		...
		header('location:admin_data_absensi_teori_lihat.php?lihat='.$kd_mata_kuliah.'&fail='.$mysqli->errno);
	} else {
		header('location:admin_data_absensi_teori_lihat.php?lihat='.$kd_mata_kuliah.'&success=1');
	}
?>