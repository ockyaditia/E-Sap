  ...
  <body>
			...
			<div class="contact-form">
				...
				?>
					<div class="alert alert-danger" role="alert">
						<center><strong>Gagal Tambah Data!</strong>. Kode Laboratorium Telah Terdaftar.</center>
					</div>
				<?php
	...
	<div class="container" style="color:black;">
		<div class="panel panel-default">
			...
			<div align="right">
				<a href ="admin_data_laboratorium_tambah.php">
			...
			<div class="panel-body">
				<div class="dataTable_wrapper">
					<?php 
						...
						$sql = "SELECT * from laboratorium WHERE kd_prodi = '".$_SESSION['kd_prodi']."'";
					...
					<table class="table table-striped table-bordered table-hover" id="dataTables-example">
						<thead>
							<tr>
								...
								<th style="cursor:pointer;"><center>NIK Dosen PJ <img src="data-grid/datatables/media/images/sort_both.png"></center></th>
								<th style="cursor:pointer;"><center>Nama Dosen PJ <img src="data-grid/datatables/media/images/sort_both.png"></center></th>
								<th style="cursor:pointer;"><center>Nama Lab <img src="data-grid/datatables/media/images/sort_both.png"></center></th>
								<th>Opsi</th>
							</tr>
						</thead>
						<tbody>
							...
							?>
								<tr>
									...
									<td><center><?php echo $data['nik_dosen_pj']; ?></center></td>
									<td><center>
										<?php
											$sql4 = "SELECT * from mst_dosen WHERE nik = '".$data['nik_dosen_pj']."'";
											...
											echo $data4['nama_dosen'];
										?>
									</center></td>
									<td><center><?php echo $data['nama_lab']; ?></center></td>
									<td>
										<center>
											<a href="admin_data_laboratorium_ubah.php?ubah=<?php echo $data['kd_ruang']; ?>">
												<img src="images/edit_green.png" style="margin-left:10px;" width="30" height="30"/>
											</a>
										
											<a href="admin_data_laboratorium_kueri_delete.php?hapus=<?php echo $data['kd_ruang']; ?>" onclick="return doconfirm()">
