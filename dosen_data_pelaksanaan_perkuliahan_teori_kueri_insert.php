<?php
	...
	if (!$result = $mysqli->query($sql)) {
		...
		header('location:dosen_data_pelaksanaan_perkuliahan_teori_lihat.php?lihat='.$kd_mata_kuliah.'&fail='.$mysqli->errno);
	} else {
		header('location:dosen_data_pelaksanaan_perkuliahan_teori_lihat.php?lihat='.$kd_mata_kuliah.'&success=1');
	}
?>