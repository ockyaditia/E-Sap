  ...
  <body>
	...
	<div class="container" style="color:black;">
		<div class="panel panel-default">
			...
			<div align="right">
				<a href ="admin_data_program_studi_tambah.php">
				...
				<div class="dataTable_wrapper">
					<?php 
						...
						if ($_SESSION['kd_prodi'] == "") {
							$sql = "SELECT * from mst_program_studi";
						} else {
							$sql = "SELECT * from mst_program_studi WHERE kd_prodi = '".$_SESSION['kd_prodi']."'";
						}
					...
					<table class="table table-striped table-bordered table-hover" id="dataTables-example">
						<thead>
							<tr>
								...
								<th style="cursor:pointer;"><center>Kode Program Studi <img src="data-grid/datatables/media/images/sort_both.png"></center></th>
								<th style="cursor:pointer;"><center>Nama Program Studi <img src="data-grid/datatables/media/images/sort_both.png"></center></th>
								<th>Opsi</th>
							</tr>
						</thead>
						<tbody>
							...
							?>
								<tr>
									...
									<td><center>
										<?php
											$sql2 = "SELECT * from mst_fakultas WHERE kd_fakultas = '".$data['kd_fakultas']."'";
											if (!$result2 = $mysqli->query($sql2)) {
												$message2 = "Sorry, the website is experiencing problems.";
												echo "<script type='text/javascript'>alert('$message2');</script>";
											}
											$data2 = $result2->fetch_assoc();
											echo $data2['nama_fakultas'];
										?>
									</center></td>
									<td><center><?php echo $data['kd_prodi']; ?></center></td>
									<td><center><?php echo $data['nama_prodi']; ?></center></td>
									<td>
										<center>
											<a href="admin_data_program_studi_ubah.php?ubah=<?php echo $data['kd_prodi']; ?>">
												<img src="images/edit_green.png" style="margin-left:10px;" width="30" height="30"/>
											</a>
										
											<a href="admin_data_program_studi_kueri_delete.php?hapus=<?php echo $data['kd_prodi']; ?>" onclick="return doconfirm()">
