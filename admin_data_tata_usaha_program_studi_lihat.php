  ...
  <body>
	...
	<div id="breadcrumb">
		<div class="container">	
			<div class="breadcrumb">							
				...
				<li>Data Tata Usaha Program Studi</li>			
			</div>		
		</div>	
	</div>
	...
	<div class="container" style="color:black;">
		<div class="panel panel-default">
			...
			<div align="right">
				<a href ="admin_data_tata_usaha_program_studi_tambah.php">
				...
				<div class="dataTable_wrapper">
					<?php 
						...
						if ($_SESSION['kd_prodi'] == "") {
							$sql = "SELECT * from mst_tata_usaha WHERE kd_prodi != ''";
						} else {
							$sql = "SELECT * from mst_tata_usaha WHERE kd_prodi = '".$_SESSION['kd_prodi']."'";
						}
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td><center><?php echo $data['nama_tata_usaha']; ?></center></td>
									<td><center>
										<?php
									...
									<td>
										<center>
											<a href="admin_data_tata_usaha_program_studi_ubah.php?ubah=<?php echo $data['nik']; ?>">
												<img src="images/edit_green.png" style="margin-left:10px;" width="30" height="30"/>
											</a>
										
											<a href="admin_data_tata_usaha_program_studi_kueri_delete.php?hapus=<?php echo $data['nik']; ?>" onclick="return doconfirm()">
