  ...
  <body>
	...
	<script>
		function checkAvailability() {
			$("#loaderIcon").show();
			jQuery.ajax({
				url		: "check_availability_kd_dosen_ubah.php",
            ...
            <div class="row contact-wrap">
                ...
                <div class="col-md-6 col-md-offset-3">
					...
					<?php
						...
						$sql = "SELECT mst_dosen.nik, mst_dosen.kd_prodi, mst_dosen.nama_dosen, mst_dosen.jabatan, user_akses.username FROM mst_dosen INNER JOIN user_akses ON mst_dosen.nik = user_akses.kd_user WHERE mst_dosen.nik='$nik'";
                    ...
                    <form action="admin_data_dosen_kueri_update.php" method="post" role="form" class="contactForm">
						...
						<div class="form-group">
								<input type="text" class="form-control" name="nama_dosen" id="nama_dosen" placeholder="Nama" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" required value="<?php echo $nama_dosen; ?>"/>
								<div class="validation"></div>
						</div>
						<div class="form-group">
								<input type="text" class="form-control" name="jabatan" id="jabatan" placeholder="Jabatan" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" value="<?php echo $jabatan; ?>"/>
								<div class="validation"></div>
						</div>
						<div class="form-group">
				...
				<?php
						...
						header('location:admin_data_dosen_lihat.php');
					}
				?>
            </div><!--/.row-->
        </div><!--/.container-->
