	...
	<div id="breadcrumb">
		<div class="container">	
			<div class="breadcrumb">							
				<li><a href="dosen_data_mata_kuliah_lihat.php">Data Mata Kuliah</a></li>
	...
	<div class="container" style="color:black;">
		<div class="panel panel-default">
			...
			<?php
				...
				$nik_koordinator_mata_kuliah = $_SESSION['nik'];
			?>
			<div>
			...
			<div align="center">
				...
				<form action="dosen_data_sap_kueri_insert.php" method="post" role="form" class="contactForm">
					<table class="sap">
						<tr>
							<th>Bentuk Kuliah</th>
							<td colspan="2">
						...
						<tr>
							...
							<td colspan="4">
								<select class="form-control" name="mk_prasyarat" id="mk_prasyarat">
									<option value="" disabled selected>Pilih Mata Kuliah Prasyarat</option>
									<?php
										require ("config/config.php");
										$sql3 = "SELECT * from mata_kuliah WHERE kd_prodi='".$_SESSION['kd_prodi']."' AND nama_mata_kuliah != '$nama_mata_kuliah'";
									...
									?>
										<option value="<?php echo $data3['nama_mata_kuliah'];?>"
									<?php
										if ($mk_prasyarat == $data3['nama_mata_kuliah']) {
											echo ' selected="selected"';
										} 
									?>
										>
									<?php
											echo $data3['nama_mata_kuliah'];
									?>
										</option>
									<?php
										}
						...
						<tr>
							...
							<td>
								...
								<br>
								: <input type="number" id="bobot_praktikum_dan_keaktifan" name="bobot_praktikum_dan_keaktifan" style="width:50px;" value="<?php echo $bobot_praktikum_dan_keaktifan; ?>"/>&nbsp;%
							</td>
						</tr>
						<tr>
							<th>Rujukan</th>
				...
				<form action="dosen_data_rincian_materi_kuliah_kueri_insert.php" method="post" role="form" class="contactForm">
					<input type="hidden" id="kd_mata_kuliah" name="kd_mata_kuliah" value="<?php echo $kd_mata_kuliah; ?>" />
					<table class="sap">
						<tr>
						...
						<tr>
							...
							<td style="text-align:center">
								<input type="checkbox" name="1K" value="K" <?php if (strpos($kegiatan_belajar1, 'K') !== false) { echo ' checked'; } ?>/> K&nbsp;
								<input type="checkbox" name="1D" value="D" <?php if (strpos($kegiatan_belajar1, 'D') !== false) { echo ' checked'; } ?>/> D&nbsp;
								<input type="checkbox" name="1R" value="R" <?php if (strpos($kegiatan_belajar1, 'R') !== false) { echo ' checked'; } ?>/> R&nbsp;
								<input type="checkbox" name="1S" value="S" <?php if (strpos($kegiatan_belajar1, 'S') !== false) { echo ' checked'; } ?>/> S
							</td>
						</tr>
						<tr>
							...
							<td style="text-align:center">
								<input type="checkbox" name="2K" value="K" <?php if (strpos($kegiatan_belajar2, 'K') !== false) { echo ' checked'; } ?>/> K&nbsp;
								<input type="checkbox" name="2D" value="D" <?php if (strpos($kegiatan_belajar2, 'D') !== false) { echo ' checked'; } ?>/> D&nbsp;
								<input type="checkbox" name="2R" value="R" <?php if (strpos($kegiatan_belajar2, 'R') !== false) { echo ' checked'; } ?>/> R&nbsp;
								<input type="checkbox" name="2S" value="S" <?php if (strpos($kegiatan_belajar2, 'S') !== false) { echo ' checked'; } ?>/> S
							</td>
						</tr>
						<tr>
							...
							<td style="text-align:center">
								<input type="checkbox" name="3K" value="K" <?php if (strpos($kegiatan_belajar3, 'K') !== false) { echo ' checked'; } ?>/> K&nbsp;
								<input type="checkbox" name="3D" value="D" <?php if (strpos($kegiatan_belajar3, 'D') !== false) { echo ' checked'; } ?>/> D&nbsp;
								<input type="checkbox" name="3R" value="R" <?php if (strpos($kegiatan_belajar3, 'R') !== false) { echo ' checked'; } ?>/> R&nbsp;
								<input type="checkbox" name="3S" value="S" <?php if (strpos($kegiatan_belajar3, 'S') !== false) { echo ' checked'; } ?>/> S
							</td>
						</tr>
						<tr>
							...
							<td style="text-align:center">
								<input type="checkbox" name="4K" value="K" <?php if (strpos($kegiatan_belajar4, 'K') !== false) { echo ' checked'; } ?>/> K&nbsp;
								<input type="checkbox" name="4D" value="D" <?php if (strpos($kegiatan_belajar4, 'D') !== false) { echo ' checked'; } ?>/> D&nbsp;
								<input type="checkbox" name="4R" value="R" <?php if (strpos($kegiatan_belajar4, 'R') !== false) { echo ' checked'; } ?>/> R&nbsp;
								<input type="checkbox" name="4S" value="S" <?php if (strpos($kegiatan_belajar4, 'S') !== false) { echo ' checked'; } ?>/> S
							</td>
						</tr>
						<tr>
							...
							<td style="text-align:center">
								<input type="checkbox" name="5K" value="K" <?php if (strpos($kegiatan_belajar5, 'K') !== false) { echo ' checked'; } ?>/> K&nbsp;
								<input type="checkbox" name="5D" value="D" <?php if (strpos($kegiatan_belajar5, 'D') !== false) { echo ' checked'; } ?>/> D&nbsp;
								<input type="checkbox" name="5R" value="R" <?php if (strpos($kegiatan_belajar5, 'R') !== false) { echo ' checked'; } ?>/> R&nbsp;
								<input type="checkbox" name="5S" value="S" <?php if (strpos($kegiatan_belajar5, 'S') !== false) { echo ' checked'; } ?>/> S
							</td>
						</tr>
						<tr>
							...
							<td style="text-align:center">
								<input type="checkbox" name="6K" value="K" <?php if (strpos($kegiatan_belajar6, 'K') !== false) { echo ' checked'; } ?>/> K&nbsp;
								<input type="checkbox" name="6D" value="D" <?php if (strpos($kegiatan_belajar6, 'D') !== false) { echo ' checked'; } ?>/> D&nbsp;
								<input type="checkbox" name="6R" value="R" <?php if (strpos($kegiatan_belajar6, 'R') !== false) { echo ' checked'; } ?>/> R&nbsp;
								<input type="checkbox" name="6S" value="S" <?php if (strpos($kegiatan_belajar6, 'S') !== false) { echo ' checked'; } ?>/> S
							</td>
						</tr>
						<tr>
							...
							<td style="text-align:center">
								<input type="checkbox" name="7K" value="K" <?php if (strpos($kegiatan_belajar7, 'K') !== false) { echo ' checked'; } ?>/> K&nbsp;
								<input type="checkbox" name="7D" value="D" <?php if (strpos($kegiatan_belajar7, 'D') !== false) { echo ' checked'; } ?>/> D&nbsp;
								<input type="checkbox" name="7R" value="R" <?php if (strpos($kegiatan_belajar7, 'R') !== false) { echo ' checked'; } ?>/> R&nbsp;
								<input type="checkbox" name="7S" value="S" <?php if (strpos($kegiatan_belajar7, 'S') !== false) { echo ' checked'; } ?>/> S
							</td>
						</tr>
						<tr>
							...
							<td style="text-align:center">
								<input type="checkbox" name="8K" value="K" <?php if (strpos($kegiatan_belajar8, 'K') !== false) { echo ' checked'; } ?>/> K&nbsp;
								<input type="checkbox" name="8D" value="D" <?php if (strpos($kegiatan_belajar8, 'D') !== false) { echo ' checked'; } ?>/> D&nbsp;
								<input type="checkbox" name="8R" value="R" <?php if (strpos($kegiatan_belajar8, 'R') !== false) { echo ' checked'; } ?>/> R&nbsp;
								<input type="checkbox" name="8S" value="S" <?php if (strpos($kegiatan_belajar8, 'S') !== false) { echo ' checked'; } ?>/> S
							</td>
						</tr>
						<tr>
							...
							<td style="text-align:center">
								<input type="checkbox" name="9K" value="K" <?php if (strpos($kegiatan_belajar9, 'K') !== false) { echo ' checked'; } ?>/> K&nbsp;
								<input type="checkbox" name="9D" value="D" <?php if (strpos($kegiatan_belajar9, 'D') !== false) { echo ' checked'; } ?>/> D&nbsp;
								<input type="checkbox" name="9R" value="R" <?php if (strpos($kegiatan_belajar9, 'R') !== false) { echo ' checked'; } ?>/> R&nbsp;
								<input type="checkbox" name="9S" value="S" <?php if (strpos($kegiatan_belajar9, 'S') !== false) { echo ' checked'; } ?>/> S
							</td>
						</tr>
						<tr>
							...
							<td style="text-align:center">
								<input type="checkbox" name="10K" value="K" <?php if (strpos($kegiatan_belajar10, 'K') !== false) { echo ' checked'; } ?>/> K&nbsp;
								<input type="checkbox" name="10D" value="D" <?php if (strpos($kegiatan_belajar10, 'D') !== false) { echo ' checked'; } ?>/> D&nbsp;
								<input type="checkbox" name="10R" value="R" <?php if (strpos($kegiatan_belajar10, 'R') !== false) { echo ' checked'; } ?>/> R&nbsp;
								<input type="checkbox" name="10S" value="S" <?php if (strpos($kegiatan_belajar10, 'S') !== false) { echo ' checked'; } ?>/> S
							</td>
						</tr>
						<tr>
							...
							<td style="text-align:center">
								<input type="checkbox" name="11K" value="K" <?php if (strpos($kegiatan_belajar11, 'K') !== false) { echo ' checked'; } ?>/> K&nbsp;
								<input type="checkbox" name="11D" value="D" <?php if (strpos($kegiatan_belajar11, 'D') !== false) { echo ' checked'; } ?>/> D&nbsp;
								<input type="checkbox" name="11R" value="R" <?php if (strpos($kegiatan_belajar11, 'R') !== false) { echo ' checked'; } ?>/> R&nbsp;
								<input type="checkbox" name="11S" value="S" <?php if (strpos($kegiatan_belajar11, 'S') !== false) { echo ' checked'; } ?>/> S
							</td>
						</tr>
						<tr>
							...
							<td style="text-align:center">
								<input type="checkbox" name="12K" value="K" <?php if (strpos($kegiatan_belajar12, 'K') !== false) { echo ' checked'; } ?>/> K&nbsp;
								<input type="checkbox" name="12D" value="D" <?php if (strpos($kegiatan_belajar12, 'D') !== false) { echo ' checked'; } ?>/> D&nbsp;
								<input type="checkbox" name="12R" value="R" <?php if (strpos($kegiatan_belajar12, 'R') !== false) { echo ' checked'; } ?>/> R&nbsp;
								<input type="checkbox" name="12S" value="S" <?php if (strpos($kegiatan_belajar12, 'S') !== false) { echo ' checked'; } ?>/> S
							</td>
						</tr>
						<tr>
							...
							<td style="text-align:center">
								<input type="checkbox" name="13K" value="K" <?php if (strpos($kegiatan_belajar13, 'K') !== false) { echo ' checked'; } ?>/> K&nbsp;
								<input type="checkbox" name="13D" value="D" <?php if (strpos($kegiatan_belajar13, 'D') !== false) { echo ' checked'; } ?>/> D&nbsp;
								<input type="checkbox" name="13R" value="R" <?php if (strpos($kegiatan_belajar13, 'R') !== false) { echo ' checked'; } ?>/> R&nbsp;
								<input type="checkbox" name="13S" value="S" <?php if (strpos($kegiatan_belajar13, 'S') !== false) { echo ' checked'; } ?>/> S
							</td>
						</tr>
						<tr>
							...
							<td style="text-align:center">
								<input type="checkbox" name="14K" value="K" <?php if (strpos($kegiatan_belajar14, 'K') !== false) { echo ' checked'; } ?>/> K&nbsp;
								<input type="checkbox" name="14D" value="D" <?php if (strpos($kegiatan_belajar14, 'D') !== false) { echo ' checked'; } ?>/> D&nbsp;
								<input type="checkbox" name="14R" value="R" <?php if (strpos($kegiatan_belajar14, 'R') !== false) { echo ' checked'; } ?>/> R&nbsp;
								<input type="checkbox" name="14S" value="S" <?php if (strpos($kegiatan_belajar14, 'S') !== false) { echo ' checked'; } ?>/> S
							</td>
						</tr>
						<tr>
							...
							<td style="text-align:center">
								<input type="checkbox" name="15K" value="K" <?php if (strpos($kegiatan_belajar15, 'K') !== false) { echo ' checked'; } ?>/> K&nbsp;
								<input type="checkbox" name="15D" value="D" <?php if (strpos($kegiatan_belajar15, 'D') !== false) { echo ' checked'; } ?>/> D&nbsp;
								<input type="checkbox" name="15R" value="R" <?php if (strpos($kegiatan_belajar15, 'R') !== false) { echo ' checked'; } ?>/> R&nbsp;
								<input type="checkbox" name="15S" value="S" <?php if (strpos($kegiatan_belajar15, 'S') !== false) { echo ' checked'; } ?>/> S
							</td>
						</tr>
						<tr>
							...
							<td style="text-align:center">
								<input type="checkbox" name="16K" value="K" <?php if (strpos($kegiatan_belajar16, 'K') !== false) { echo ' checked'; } ?>/> K&nbsp;
								<input type="checkbox" name="16D" value="D" <?php if (strpos($kegiatan_belajar16, 'D') !== false) { echo ' checked'; } ?>/> D&nbsp;
								<input type="checkbox" name="16R" value="R" <?php if (strpos($kegiatan_belajar16, 'R') !== false) { echo ' checked'; } ?>/> R&nbsp;
								<input type="checkbox" name="16S" value="S" <?php if (strpos($kegiatan_belajar16, 'S') !== false) { echo ' checked'; } ?>/> S
							</td>
						</tr>
					</table>
					...
					<table class="sap" style="border:none;">
						...
						<tr style="border:none;">
							<th style="border:none;"><h4>
								<?php
									$sql1 = "SELECT * from mst_dosen WHERE nik = '".$_SESSION['nik']."'";
						...
						function addMoreRows1(frm) {
							if (rowCount1 <= 9) {
								...
								'<div id="rowCount1'+rowCount1+'">'+
									...
									'<input style="" class="form-control" type="text" id="sub_topik1_'+rowCount1+'" name="sub_topik1_'+rowCount1+'" placeholder="Sub Topik 1.'+rowCount1+'" value="'+sub_topik1_[rowCount1]+'"/>'+
								'</div>';
						...
						function addMoreRows2(frm) {
							if (rowCount2 <= 9) {
								...
								'<div id="rowCount2'+rowCount2+'">'+
									...
									'<input style="" class="form-control" type="text" id="sub_topik2_'+rowCount2+'" name="sub_topik2_'+rowCount2+'" placeholder="Sub Topik 2.'+rowCount2+'" value="'+sub_topik2_[rowCount2]+'"/>'+
								'</div>';
						...
						function addMoreRows3(frm) {
							if (rowCount3 <= 9) {
								...
								'<div id="rowCount3'+rowCount3+'">'+
									...
									'<input style="" class="form-control" type="text" id="sub_topik3_'+rowCount3+'" name="sub_topik3_'+rowCount3+'" placeholder="Sub Topik 3.'+rowCount3+'" value="'+sub_topik3_[rowCount3]+'"/>'+
								'</div>';
						...
						function addMoreRows4(frm) {
							if (rowCount4 <= 9) {
								...
								'<div id="rowCount4'+rowCount4+'">'+
									...
									'<input style="" class="form-control" type="text" id="sub_topik4_'+rowCount4+'" name="sub_topik4_'+rowCount4+'" placeholder="Sub Topik 4.'+rowCount4+'" value="'+sub_topik4_[rowCount4]+'"/>'+
								'</div>';
						...
						function addMoreRows5(frm) {
							if (rowCount5 <= 9) {
								...
								'<div id="rowCount5'+rowCount5+'">'+
									...
									'<input style="" class="form-control" type="text" id="sub_topik5_'+rowCount5+'" name="sub_topik5_'+rowCount5+'" placeholder="Sub Topik 5.'+rowCount5+'" value="'+sub_topik5_[rowCount5]+'"/>'+
								'</div>';
						...
						function addMoreRows6(frm) {
							if (rowCount6 <= 9) {
								...
								'<div id="rowCount6'+rowCount6+'">'+
									...
									'<input style="" class="form-control" type="text" id="sub_topik6_'+rowCount6+'" name="sub_topik6_'+rowCount6+'" placeholder="Sub Topik 6.'+rowCount6+'" value="'+sub_topik6_[rowCount6]+'"/>'+
								'</div>';
						...
						function addMoreRows7(frm) {
							if (rowCount7 <= 9) {
								...
								'<div id="rowCount7'+rowCount7+'">'+
									...
									'<input style="" class="form-control" type="text" id="sub_topik7_'+rowCount7+'" name="sub_topik7_'+rowCount7+'" placeholder="Sub Topik 7.'+rowCount7+'" value="'+sub_topik7_[rowCount7]+'"/>'+
								'</div>';
						...
						function addMoreRows8(frm) {
							if (rowCount8 <= 9) {
								...
								'<div id="rowCount8'+rowCount8+'">'+
									...
									'<input style="" class="form-control" type="text" id="sub_topik8_'+rowCount8+'" name="sub_topik8_'+rowCount8+'" placeholder="Sub Topik 8.'+rowCount8+'" value="'+sub_topik8_[rowCount8]+'"/>'+
								'</div>';
						...
						function addMoreRows9(frm) {
							if (rowCount9 <= 9) {
								...
								'<div id="rowCount9'+rowCount9+'">'+
									...
									'<input style="" class="form-control" type="text" id="sub_topik9_'+rowCount9+'" name="sub_topik9_'+rowCount9+'" placeholder="Sub Topik 9.'+rowCount9+'" value="'+sub_topik9_[rowCount9]+'"/>'+
								'</div>';
						...
						function addMoreRows10(frm) {
							if (rowCount10 <= 9) {
								...
								'<div id="rowCount10'+rowCount10+'">'+
									...
									'<input style="" class="form-control" type="text" id="sub_topik10_'+rowCount10+'" name="sub_topik10_'+rowCount10+'" placeholder="Sub Topik 10.'+rowCount10+'" value="'+sub_topik10_[rowCount10]+'"/>'+
								'</div>';
						...
						function addMoreRows11(frm) {
							if (rowCount11 <= 9) {
								...
								'<div id="rowCount11'+rowCount11+'">'+
									...
									'<input style="" class="form-control" type="text" id="sub_topik11_'+rowCount11+'" name="sub_topik11_'+rowCount11+'" placeholder="Sub Topik 11.'+rowCount11+'" value="'+sub_topik11_[rowCount11]+'"/>'+
								'</div>';
						...
						function addMoreRows12(frm) {
							if (rowCount12 <= 9) {
								...
								'<div id="rowCount12'+rowCount12+'">'+
									...
									'<input style="" class="form-control" type="text" id="sub_topik12_'+rowCount12+'" name="sub_topik12_'+rowCount12+'" placeholder="Sub Topik 12.'+rowCount12+'" value="'+sub_topik12_[rowCount12]+'"/>'+
								'</div>';
						...
						function addMoreRows13(frm) {
							if (rowCount13 <= 9) {
								...
								'<div id="rowCount13'+rowCount13+'">'+
									...
									'<input style="" class="form-control" type="text" id="sub_topik13_'+rowCount13+'" name="sub_topik13_'+rowCount13+'" placeholder="Sub Topik 13.'+rowCount13+'" value="'+sub_topik13_[rowCount13]+'"/>'+
								'</div>';
						...
						function addMoreRows14(frm) {
							if (rowCount14 <= 9) {
								...
								'<div id="rowCount14'+rowCount14+'">'+
									...
									'<input style="" class="form-control" type="text" id="sub_topik14_'+rowCount14+'" name="sub_topik14_'+rowCount14+'" placeholder="Sub Topik 14.'+rowCount14+'" value="'+sub_topik14_[rowCount14]+'"/>'+
								'</div>';
						...
						function addMoreRows15(frm) {
							if (rowCount15 <= 9) {
								...
								'<div id="rowCount15'+rowCount15+'">'+
									...
									'<input style="" class="form-control" type="text" id="sub_topik15_'+rowCount15+'" name="sub_topik15_'+rowCount15+'" placeholder="Sub Topik 15.'+rowCount15+'" value="'+sub_topik15_[rowCount15]+'"/>'+
								'</div>';
						...
						function addMoreRows16(frm) {
							if (rowCount16 <= 9) {
								...
								'<div id="rowCount16'+rowCount16+'">'+
									...
									'<input style="" class="form-control" type="text" id="sub_topik16_'+rowCount16+'" name="sub_topik16_'+rowCount16+'" placeholder="Sub Topik 16.'+rowCount16+'" value="'+sub_topik16_[rowCount16]+'"/>'+
								'</div>';
